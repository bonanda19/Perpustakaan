                    ...
                    <div class="container">
                      ...
                      <div >
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton2">
                              @foreach ($jilid as $ji)
                                  <li><a class="dropdown-item" href="{{ route('JilidBuku', $ji->id) }}">{{ $ji->name }}</a></li>
                              @endforeach
                        </ul>
                      </div>
                      {{-- endDropdown --}}
                      ...
                      <div id="list-th">
                        ...
                        @foreach ($index as $i)
                            <div class="book read">
                                <div class="cover">
                                    <a href="/index/{{ $i->id }}"><img src="{{ asset('storage/' . $i->image) }}"></a>
                                </div>
                                <div class="description">
                                  <a href="/index/{{ $i->id }}"><p class="title">{{ $i->Judul }}</a>  
                                </div>
                            </div>
                        @endforeach
